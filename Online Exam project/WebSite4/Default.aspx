...
<body>
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#E0E0E0" BorderColor="#E0E0E0" Height="264px"
            Style="z-index: 104; left: 135px; position: absolute; top: 55px" Visible="False"
            ...
            <asp:Panel ID="Panel2" runat="server" Height="214px" Style="z-index: 103; left: 4px;
                position: absolute; top: 46px" Width="696px">
                <asp:Label ID="lblQuestion" runat="server" Style="z-index: 100; left: 5px; position: absolute;
                    top: 16px" Text="Label" Width="682px"></asp:Label>
